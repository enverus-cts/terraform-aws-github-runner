...
| <a name="input_monitor_lambda_zip"></a> [monitor\_lambda\_zip](#input\_monitor\_lambda\_zip) | File location of the lambda zip file for monitor runners. | `string` | `null` | no |
